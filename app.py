...
# Load pipeline
pipeline = load("ml/pipeline.joblib")
# Load the label encoders
le_sex = load_p(open('ml/le_sex.pkl', 'rb'))
le_state = load_p(open('ml/le_state.pkl', 'rb'))
le_race = load_p(open('ml/le_race.pkl', 'rb'))
le_ethnicity = load_p(open('ml/le_ethnicity.pkl', 'rb'))
le_age = load_p(open('ml/le_age.pkl', 'rb'))
